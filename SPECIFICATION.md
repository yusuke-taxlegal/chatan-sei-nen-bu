...
```javascript
{
  ...
  sns: string,                     // 旧SNSリンク（後方互換）
  twitter: string,                 // X (旧Twitter) のURL
  facebook: string,                // Facebook のURL
  instagram: string,               // Instagram のURL
  tiktok: string,                  // TikTok のURL
  ...
  currentRole: string,             // 現在の役職（"部長", "副部長", ""）
  pastRoles: string[],             // 過去に経験した役職（"部長", "副部長"）
  enrollmentYear: number,          // 入部年度（例: 2020）
